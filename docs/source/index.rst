...
and signal-to-noise in astronomcial observations.  Important functionalities include:
...
and its second-order coherence function :math:`g^{(2)}`. The observation is specified by the telescope aperture, baseline between telesocopes, the
